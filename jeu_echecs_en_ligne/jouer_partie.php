...
<body>
	<?php
		...
		// récupération de si le joueur est noir ou blanc :
			...
			echo 'vous êtes la couleur ' . $couleur_joueur . ' votre identifiant est ' . $id_joueur;
		...
		if(($a_propose_nulle == 1 && $couleur_joueur == "noir") || ($a_propose_nulle == 2 && $couleur_joueur == "blanc"))
		{
			echo '
			<form method="post">
		...
		if(isset($_POST['envoyer']) && $_POST['action'] == "reponse_null")
		{
			echo "vous avez bien accépté nulle";
		}
		...
		if(($joueur_dont_c_est_le_tour == 1 && $couleur_joueur == "blanc") || ($joueur_dont_c_est_le_tour == 2 && $couleur_joueur == "noir"))
		{
			...
			if(isset($_POST['proposer_partie_nulle']) && $_POST['proposer_partie_nulle'] == "Proposer partie nulle")
			{
				...
				echo "vous avec bien proposé partie nulle";
			}
		}
		else
		{
